  ...
  return (
    <div>
      <div id="bio" className="col s12 m10 l8 glitchin">
        <p>
          I've played with code since I got my first computer in high school. A refurbished HP
          desktop and dial-up introduced me to the World Wide Web. Fascinated, I discovered that
          regular people were making the websites I happened upon. So, I went in search of the
          how-to's to learn HTML. And before I knew it, I had built several sites on Angelfire and
          Geocities.
        </p>

        <p>
          Fast forward a few years, I discovered WordPress and CSS. It took a bit of learning but I
          caught on fast. Over the next 6 - 7 years, I had at least one website running to discuss
          my life or hobbies. And while coding was a passion, I never really thought about doing
          more with it.
        </p>
        <p>
          Today, I have built my own web design/development business from the ground up. Starting
          with only one client in 2015, I now have built more than 10 websites for clients. I have
          added Javascript ES6, ReactJS, Bootstrap, and MaterializeCSS to my coding skills, using
          FreeCodeCamp's curriculum to continue to move towards becoming a Full Stack Developer. I
          have built several pages and apps to practice my skills, which you can find on my Github
          profile.
        </p>
        <div className="col s12 m3 l2">
          <button
            target="_blank"
            href="https://github.com/rockstarcreativestudio"
            rel="noopener noreferrer"
            className="btn purple accent-3 waves-effect"
          >
